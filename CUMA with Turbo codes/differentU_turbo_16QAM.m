...
BER_results_16QAM = zeros(2, length(U_values)); % Store BER results
K=0;
L=100;
...
for u_idx = 1:length(U_values)
    ...
    BER_results_16QAM(1, u_idx) = average_BER_users_turbo;
    BER_results_16QAM(2, u_idx) = average_BER_users;
end
