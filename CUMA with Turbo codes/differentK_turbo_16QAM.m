...
K_values = [0, 10, 20, 30, 40]; % different rician factor
BER_results_16QAM = zeros(2, length(K_values)); % Store BER results
L=100;
...
for k_index = 1:length(K_values)
    ...
    BER_results_16QAM(1, k_index) = average_BER_users_turbo;
    BER_results_16QAM(2, k_index) = average_BER_users;
end
