...
port_counts = [10, 20, 30, 40, 50]; % Different N1 = N2 values
BER_results_64QAM = zeros(2, length(port_counts)); % Store BER results
L=100;
K=0;
...
for p = 1:length(port_counts)
    ...
    BER_results_64QAM(1, p) = average_BER_users_turbo;
    BER_results_64QAM(2, p) = average_BER_users; 
end
