...
rho_values = 0:0.1:1; % ρ
BER_results_64QAM = zeros(2, length(rho_values)); % Store BER results
L=100;
K=0;
...
for r = 1:length(rho_values)
    ...
    BER_results_64QAM(1, r) = average_BER_users_turbo;
    BER_results_64QAM(2, r) = average_BER_users; 
end
