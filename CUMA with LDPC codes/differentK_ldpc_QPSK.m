...
BER_results_QPSK = zeros(2, length(K_values)); % Store BER results
L=100;
...
for k_index = 1:length(K_values)
    ...
    BER_results_QPSK(1, k_index) = average_BER_users_ldpc;
    BER_results_QPSK(2, k_index) = average_BER_users;
end
